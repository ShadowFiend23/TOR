...
class RegistrarController extends Controller
{
    ...
    public function fetchTorData(Request $request){
        ...
        $data = (object)[
            ...
            "ncee_percentile" => $student->ncee,
            "date_taken" => $student->nceeDate,
            "elementary" => $student->elementarySchool,
            "secondary" => $student->secondarySchool,
            "credentials" => 2,
            "remarks" => 2,
            ...
            "date_of_admission" => date("m-d-y",strtotime($student->created_at)),
            "address_1" => "$student->street, $student->barangay, $student->town",
            "place_of_birth" => $student->birthPlace,

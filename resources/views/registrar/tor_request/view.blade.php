<x-registrar_layout>
    ...
    <div class="container-lg py-4 d-flex justify-content-center position-relative">
        <div id="render-placeholder"
            class="position-absolute bg-black opacity-75 top-0 start-0 w-100 h-100 p-4 d-flex align-items-center justify-content-center gap-2"
            style="z-index: 1; transform: scale(200%);">
            <div class="spinner-border text-light" role="status">
                <span class="visually-hidden">Rendering...</span>
            </div>
            <h4 class="text-light">Rendering...</h4>
        </div>
                            ...
                            <div class="overlap">
                                <div class="tabloid"><img class="evsu" src="{{ asset('evsu-1@2x.png') }}">
                                    ...
                                    <p class="mission-develop-a"><span class="text-wrapper">Mission<br></span><span
                                            class="span">Develop a Strong Technologically and<br>Professionally
                                            Competent Productive Human<br>Resource Embued with Positive Values<br>Needed
                                            to Propel Sustainable Development</span></p>
                                    ...
                                    <div class="date-of-graduation font-9" id="date_of_graduation">date_of_graduation
                                    </div>
                                    <div class="board-of-regents font-9" id="board_of_regents">board_of_regents</div>
                                    <div class="capstone-title font-9" id="capstone_title">capstone_title</div>
                                    ...
                                    <div class="date-of-admission font-9" id="date_of_admission">date_of_admission
                                    </div>
                                ...
                                <div class="group-2">
                                    <div class="group-3">
                                        ...
                                        <p class="text-wrapper-9">TranscriptEase: A Web-Based Transcript Processing
                                            System</p>
                                                ...
                                                <div class="div-wrapper">
                                                    <div class="overlap-4">
                                                        <div class="group-5">
                                                            ...
                                                            <div class="overlap-6">
                                                                <div class="boar-of-regents-line border-bottom-cus">
                                                                </div>
                                                                <div class="text-wrapper-19">Board of Regents:</div>
                                                            </div>
                                                            <div class="overlap-7">
                                                                <div class="capstone-title-line border-bottom-cus">
                                                                </div>
                                                                <div class="text-wrapper-19">Capstone Title:</div>
                                                            </div>
                                                            <div class="overlap-8">
                                                                <div class="date-of-graduation-2 border-bottom-cus">
                                                                </div>
                                                                <div class="text-wrapper-20">Date of Graduation:</div>
                                                                <p class="text-wrapper-21">Granted under Authority of
                                                                    the EVSU Academic Council and</p>
                                                            </div>
                                                            ...
                                                            <div class="group-6">
                                                                <div class="overlap-9">
                                                                    ...
                                                                    <div class="text-wrapper-24">GRADING SYSTEM</div>
                                                                    <img class="line"
                                                                    ...
                                                                    <div class="group-7">
                                                                        ...
                                                                        <div class="text-wrapper-27">Fair or Passing
                                                                        </div>
                                                                    ...
                                                                    <div class="group-8">
                                                                        ...
                                                                        <div class="text-wrapper-31">Conditional
                                                                            Failure</div>
                                                                ...
                                                                <div class="group-14">
                                                                    <div class="overlap-11">
                                                                        <div class="text-wrapper-43">OFFICE OF THE
                                                                            REGISTRAR</div>
                                                                        <div class="text-wrapper-44">OFFICIAL
                                                                            TRANSCRIPT OF RECORD</div>
                                                                    </div>
                                                                    ...
                                                                    <div class="group-15">
                                                                        <div class="group-16">
                                                                            <div class="overlap-group-4">
                                                                                <div class="text-wrapper-45">PERSONAL
                                                                                    DATA</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="group-17">
                                                                            ...
                                                                            <div class="overlap-12">
                                                                                <div class="text-wrapper-47">Date of
                                                                                    Birth:</div>
                                                                                <div
                                                                            ...
                                                                            <div class="overlap-14">
                                                                                <div class="text-wrapper-49">Address:
                                                                                </div>
                                                                                <div class="img-2 border-bottom-cus">
                                                                                </div>
                                                                            </div>
                                                                            <div class="overlap-15">
                                                                                <div class="text-wrapper-50">Place of
                                                                                    Birth:</div>
                                                                                <div
                                                                            ...
                                                                            <div class="overlap-18">
                                                                                <div class="text-wrapper-53">Date
                                                                                    Taken:</div>
                                                                                <div
                                                                                    class="date-taken-line border-bottom-cus">
                                                                                </div>
                                                                            </div>
                                                                            <div class="name-line border-bottom-cus">
                                                                            </div>
                                                                        ...
                                                                        <div class="overlap-19">
                                                                            <div class="group-19">
                                                                                <div class="overlap-group-5">
                                                                                    ...
                                                                                    <div class="text-wrapper-55">STATE
                                                                                        OF ADMISSION</div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="group-20">
                                                                                <div class="overlap-20">
                                                                                    <div class="elementary-2">
                                                                                        Elementary:</div>
                                                                                    <div
                                                                                        class="img-3 border-bottom-cus">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="text-wrapper-56">Remarks:
                                                                                </div>
                                                                                <div class="overlap-21">
                                                                                    <div class="text-wrapper-57">
                                                                                        Course:</div>
                                                                                    <div

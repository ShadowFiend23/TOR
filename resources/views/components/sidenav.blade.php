<div class="sidebar sidebar-fixed" id="sidebar" style="background-color: #222d32;">
  <div class="sidebar-brand d-none d-md-flex" style="background-color: #861212;">
    <a class="text-decoration-none fw-bold d-flex align-items-end gap-2" href="index.html">
      ...
      <span class="text-white lh-0 pb-2">EVSU-OC</span>
    </a>
  </div>

<div id="app-sidepanel" class="app-sidepanel border border-0 z-3">
  <div id="sidepanel-drop" class="sidepanel-drop"></div>
  <div class="sidepanel-inner d-flex flex-column">
    <a href="#" id="sidepanel-close" class="sidepanel-close d-xl-none">&times;</a>
    <div class="app-branding m-0 p-0 bg-primary d-flex align-items-center justify-content-center">
        <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{ asset('images/logo.png') }}" alt="logo"><span class="logo-text text-white">EVSU-OC</span></a>
    </div>
    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1 bg-dark-subtle">
      <div class="container">
        <div class="d-flex flex-row align-items-center justify-content-start">
          <div class="profile-wrapper p-2">
            <img class="me-2 img-fluid" src="{{ asset('images/avatar.png') }}" alt="logo", style="width: 70px; height: 70px;">
          </div>
          <div class="info-wrapper d-flex flex-column gap-2">
            ...
            <div class="icon-wrapper d-flex flex-row gap-2">
              <a class="text-decoration-none border border-white d-flex align-items-center justify-content-center py-1 px-2" href="#">
      ...
      <ul class="app-menu list-unstyled accordion bg-white" id="menu-accordion">
        <li class="nav-item">
        ...
        <li class="nav-item bg-dark-subtle">
          <a class="nav-link text-white" href="add_course.html">
            <span class="nav-icon">
        ...
        <li class="nav-item bg-dark-subtle">
          <a class="nav-link text-white" href="#">
            ...
            <span class="nav-link-text">In Charge</span>
          </a>
        </li>
        ...
        <li class="nav-item bg-dark-subtle">
          <a class="nav-link text-white" href="#">
            ...
            <span class="nav-link-text">Curriculum List</span>
          </a>
        </li>
        ...
        <li class="nav-item bg-dark-subtle">
          <a class="nav-link text-white" href="#">
            ...
            <span class="nav-link-text">Latin Honor Application</span>
          </a>
        </li>
        ...
        <li class="nav-item bg-dark-subtle">
          <a class="nav-link text-white" href="#">
            ...
            <span class="nav-link-text">Final Listing of Latin Honors</span>
          </a>
        </li>
      </ul>
    </nav>

  ...
  <div class="container-fluid px-5">
    <div class="row">
      ...
      <div class="col-12 d-flex flex-row align-items-center justify-content-between">
        <div class="d-flex flex-row align-items-center py-4">
          <h4 class="fs-6 ms-3 text-black">Course: <span class="">BSIT</span></h4>
          <h4 class="fs-6 ms-3 text-black">Year Level: <span class="">3rd Year</span></h4>
          <h4 class="fs-6 ms-3 text-black">Semester: <span class="">First Semester</span></h4>
        </div>
      </div>
      <div class="col-12">
      ...
      <div class="col-12 d-flex flex-row align-items-center justify-content-between">
        <div class="d-flex flex-row align-items-center py-4">
          <h4 class="fs-6 ms-3 text-black">Course: <span class="">BSIT</span></h4>
          <h4 class="fs-6 ms-3 text-black">Year Level: <span class="">3th Year</span></h4>
          <h4 class="fs-6 ms-3 text-black">Semester: <span class="">First Semester</span></h4>
        </div>
      </div>
      <div class="col-12">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href="../../enrollment/transferee/show" class="btn btn-info text-white">Submit</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex flex-row align-items-center justify-content-between mb-4 px-4">
        ...
        <button class="btn btn-info border border-0 text-white" data-coreui-target="#selectedSubjectModal" data-coreui-toggle="modal">
          Submit
        </button>
      </div>
    </div>

  ...
  <div class="container-fluid px-5">
    <div class="row">
                  ...
                  <tr>
                    ...
                    <td class="text-center" style="width: 5%;">
                      <div class="form-check ms-4">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" style="width: 1.5rem; height: 1.5rem;">
                      </div>
                    </td>
                  </tr>
                  <tr>
      ...
      <div class="modal fade" id="confirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              <p>
                Kindly proceed with the enrollment process for the upcoming second semester. Please note that the student will be enrolling as an irregular student.
              </p>
              <div class="text-end">
                <a href="../irregular/new" class="btn btn-info btn-sm px-3 text-white">Proceed</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="d-flex flex-row align-items-center justify-content-between mb-4 px-4">
        ...
        <button class="btn btn-info border border-0 text-white" data-coreui-target="#confirmationModal" data-coreui-toggle="modal">
          Submit
        </button>
      </div>
    </div>

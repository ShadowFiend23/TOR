                ...
                <div class="d-flex flex-column flex-lg-row gap-2">
                  <div class="input-group mb-3 gap-2 flex-column">
                    <div class="course mb-3">
                      ...
                      <input id="course-name" name="course-name" type="text" class="form-control course-name" required="required">
                    </div>
                    <div class="course mb-3">
                    ...
                    <div class="course mb-3">
                      ...
                      <input id="email" name="email" type="email" class="form-control email" required="required">
                    </div>
                  </div>
                  <div class="input-group mb-3 gap-2 flex-column">
                    <div class="course mb-3">
                      <label class="sr-only mb-2" for="course-acronym">Course Acronym</label>
                      <input id="course-acronym" name="course-acronym" type="text" class="form-control course-acronym" required="required">
                    </div>
                    <div class="course mb-3">

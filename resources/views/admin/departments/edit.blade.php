        ...
        <form action="javascript:void(0)">
          <div class="row gx-0">
            <div class="col-12 col-md-6 p-1">
              ...
              <input type="text" class="form-control form-control-sm" value="Sample Department"/>
            </div>
            <div class="col-12 col-md-6 p-1">
              <label>Department Head Email</label>
              <input type="email" class="form-control form-control-sm" value="gmail@sample.com"/>
            </div>
            <div class="col-12 col-md-6 p-1">
            ...
            <div class="col-12 col-md-6 p-1">
              ...
              <input type="color" class="form-control form-control-sm" id="exampleColorInput" value="#163d7e" title="Choose your color">
            </div>
          </div>

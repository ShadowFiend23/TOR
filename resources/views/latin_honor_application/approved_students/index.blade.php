  ...
  <div class="container-fluid px-5">
    <div class="card border border-0 px-0 mx-0">
      ...
      <div class="card-header p-4  bg-dark">
        <h5 class="card-title text-white mt-2">Student List Meeting Latin Honors GPA Criteria (for evaluation)</h5>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-body">
              ...
              <div class="text-end">
                <button class="btn btn-secondary text-white btn-sm px-3" data-coreui-dismiss="modal">
                  Back
                </button>
        ...
        <table id="student_list_table" class="table table-hover" style="width:100%;">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-warning btn-sm text-white mt-3">
                  Wating for evaluation
                </button>
              </td>
            </tr>
            <tr>

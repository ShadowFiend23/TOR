...
$('#ctrl-course_abbreviated').on('change', function(){ 
	// Get the current value of the input field
    var inputValue = $(this).val();
    // Convert the input value to uppercase
    var uppercaseValue = inputValue.toUpperCase();
    // Set the input field value to the uppercase value
    $(this).val(uppercaseValue);
});
$('#ctrl-course_name').on('change', function(){ 
    // Get the input value
...
$('#ctrl-course_department').on('change', function(){ 
	// Get the input value
    var inputVal = $(this).val();
    // Capitalize the first letter of each word
    var capitalizedVal = inputVal.replace(/\b\w/g, function(match) {
...
$('#ctrl-employee_acc_firstname').on('input', function(){ 
    // Get the input value
    var inputVal = $(this).val();
    // Capitalize the first letter
    var capitalizedVal = inputVal.charAt(0).toUpperCase() + inputVal.slice(1);
    // Set the modified value back to the input
    $(this).val(capitalizedVal);
});
$('#ctrl-employee_acc_middlename').on('change', function(){ 
// Get the input value
    var inputVal = $(this).val();
    // Capitalize the first letter
    var capitalizedVal = inputVal.charAt(0).toUpperCase() + inputVal.slice(1);
...
$('#ctrl-employee_acc_lastname').on('change', function(){ 
	// Get the input value
    var inputVal = $(this).val();
    // Capitalize the first letter
    var capitalizedVal = inputVal.charAt(0).toUpperCase() + inputVal.slice(1);
...
$('#ctrl-employee_acc_suffix').on('change', function(){ 
// Get the input value
    var inputVal = $(this).val();
    // Capitalize the first letter
    var capitalizedVal = inputVal.charAt(0).toUpperCase() + inputVal.slice(1);
